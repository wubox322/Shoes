...
/****** Object:  Database [shoes]    Script Date: 22.12.2022 8:21:22 ******/
CREATE DATABASE [shoes]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'shoes', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\shoes.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'shoes_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\shoes.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [shoes] SET ANSI_NULL_DEFAULT ON 
GO

ALTER DATABASE [shoes] SET ANSI_NULLS ON 
GO

ALTER DATABASE [shoes] SET ANSI_PADDING ON 
GO

ALTER DATABASE [shoes] SET ANSI_WARNINGS ON 
GO

ALTER DATABASE [shoes] SET ARITHABORT ON 
GO
...
ALTER DATABASE [shoes] SET CURSOR_DEFAULT  LOCAL 
GO

ALTER DATABASE [shoes] SET CONCAT_NULL_YIELDS_NULL ON 
GO

ALTER DATABASE [shoes] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [shoes] SET QUOTED_IDENTIFIER ON 
GO

ALTER DATABASE [shoes] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [shoes] SET  DISABLE_BROKER 
GO
